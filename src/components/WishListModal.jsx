      ...
      {isOpen && (
        ...
        >
          <div className="d-flex justify-content-between align-items-start">
            ...
            <button onClick={onClose} className="btn-close position-absolute top-0 end-0 m-3" aria-label="Chiudi wishlist"></button>
          </div>
                    ...
                    <div className="row g-0">
                      ...
                      <div className="col-md-8 d-flex flex-column justify-content-center">
                        <div className="card-body">
                          ...
                          <button className="btn btn-outline border-0 bg-black text-white show-details-empty mt-2 w-100" onClick={() => removeFromWishList(item.id)}>
                            Remove product
                          </button>
                        </div>
                      </div>
