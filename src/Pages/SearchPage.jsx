    ...
    return (
        ...
        <>
            <div className="nav-bar search-page-filter border-top-0 page-main d-flex align-items-center">
                <button className='btn btn-outline border-0' disabled>Filter By</button>
                <div className="d-flex gap-2">
                    <button
                        onClick={() => setPriceFilterIsOn(!priceFilterIsOn)}
                        className=" btn btn-outline-dark" data-bs-toggle="button" autocomplete="off">Price</button>
                    <button
                        onClick={() => setInPromoFilterIsOn(!inPromoFilterIsOn)}
                        className=" btn btn-outline-dark" data-bs-toggle="button" autocomplete="off">In Promo</button>
                    <button
                        onClick={() => setRelevanceFilterIsOn(!relevanceFilterIsOn)}
                        className=" btn btn-outline-dark" data-bs-toggle="button" autocomplete="off">Relevant</button>
