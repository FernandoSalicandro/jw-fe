        ...
        <div className="col-md-6">
          ...
          <div className="mt-4">
            ...
            <div className="mb-3">
              ...
              <input value={redeemCode} onChange={(e) => setRedeemCode(e.target.value)} type="email" className="form-control" id="" placeholder="Coupon Code" />
              <button className="btn border-black show-details mt-3">Redeem</button>
            </div>
          </div>
            ...
            {showSummary && (
              <div id="orderSummary" className="mt-3">
                <ul className="list-group mb-3">
                  ...
                  <li className="list-group-item d-flex justify-content-between fw-bold border-0 border-top mt-2">
                    <span>Subtotal</span>
