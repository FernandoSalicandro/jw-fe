              ...
              <>
                <div className="col-md-4 mb-4 image-price" key={curWish.id}>
                  <div className="card h-100 border-0 mb-5">
                    <img onClick={() => navigate(`/productDetails/${curWish.slug}`)} src={curWish.image_url} className="card-img-top hover-img mb-2" alt={curWish.name} />
              ...
              {relatedProducts.map((product) => {
                ...
                return (
                  <div className="col mb-4 image-price" key={product.id}>
                    <div className="card h-100 border-0 mb-5">
                      <img onClick={() => navigate(`/productDetails/${product.slug}`)} src={product.image_url} className="card-img-top hover-img mb-2" alt={product.name} />
                      <div className="card-body text-center">
