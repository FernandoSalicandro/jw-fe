            ...
            <body className="body">
                {gioiello ?
                    <main className="main">
                        ...
                        <div className="pb-4">
                            <p className="text-center h2">YOU MAY ALSO LIKE...</p>
                            <div className="row row-cols-lg-4">
                                {randomItems.map((curItem) => (
                                    <div className="col image-price mt-5">
                                        <div>
                                            <img className="w-100" src={curItem.image_url} alt={curItem.name} />
                                        </div>
